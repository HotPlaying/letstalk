package com.trd.letstalk.websocket;
...
public class Server {
    ...
    public void onOpen(@PathParam("userId") String userId, Session session) {
        ...
        logger.info("---有新连接 " + userId + " 加入！当前在线人数为" + getOnlineCount());
    }
    ...
    public void onClose(@PathParam("userId") String userId) {
        ...
        logger.info("---有一连接 " + userId + " 关闭！当前在线人数为" + getOnlineCount());
    }
